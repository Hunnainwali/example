...
#
# In the CI we test the ExampleProject app build
  ...
  projects.each do |project|
    project.build_configurations.each do |config|
      ...
      if enableFrameProcessors
        Pod::UI.puts "Adding VISION_CAMERA_ENABLE_FRAME_PROCESSORS Swift flag to ExampleProject..."
        ReactNativePodsUtils.add_flag_for_key(config, flag, "OTHER_SWIFT_FLAGS")
      else
        Pod::UI.puts "Removing VISION_CAMERA_ENABLE_FRAME_PROCESSORS Swift flag from ExampleProject..."
